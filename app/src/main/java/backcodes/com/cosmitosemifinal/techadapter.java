...
public class techadapter extends RecyclerView.Adapter<techadapter.Myholder> {
    int image[];
    String name[];
    Context context;
    popup popup;
    techadapter(Context ct,int im[],String nam[])
    {
       context=ct;
       image=im;
       name=nam;
    ...
    public Myholder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.cardtech, parent, false);
