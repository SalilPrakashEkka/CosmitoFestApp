...
public class cultadapter extends RecyclerView.Adapter<cultadapter.Myholder> {
    int image[];
    String name[];
    Context context;
    popup popup;
    cultadapter(Context ct,int im[],String nam[]) {
        context = ct;
        image = im;
        name = nam;
        popup=new popup();
    ...
    public Myholder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.cardcult, parent, false);
